...
test('renders all topics', () => {
  render(<TopicPanel topics={topics} activeId="t1" onSelect={() => {}} onAdd={() => {}} onDelete={() => {}} />)
...
test('calls onSelect with topic id when clicked', () => {
  ...
  render(<TopicPanel topics={topics} activeId="t1" onSelect={onSelect} onAdd={() => {}} onDelete={() => {}} />)
...
test('calls onAdd when add topic button clicked', () => {
  const onAdd = vi.fn()
  render(<TopicPanel topics={topics} activeId="t1" onSelect={() => {}} onAdd={onAdd} onDelete={() => {}} />)
