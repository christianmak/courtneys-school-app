...
test('renders pen and eraser buttons', () => {
  render(<PenToolbar tool="pen" color="#000000" size={4} onToolChange={() => {}} onColorChange={() => {}} onSizeChange={() => {}} onClear={() => {}} onInsertImage={() => {}} />)
...
test('calls onToolChange with eraser when eraser clicked', () => {
  ...
  render(<PenToolbar tool="pen" color="#000000" size={4} onToolChange={onToolChange} onColorChange={() => {}} onSizeChange={() => {}} onClear={() => {}} onInsertImage={() => {}} />)
...
test('calls onClear when clear button clicked', () => {
  const onClear = vi.fn()
  render(<PenToolbar tool="pen" color="#000000" size={4} onToolChange={() => {}} onColorChange={() => {}} onSizeChange={() => {}} onClear={onClear} onInsertImage={() => {}} />)
