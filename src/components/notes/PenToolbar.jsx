...
export default function PenToolbar({ tool, color, size, onToolChange, onColorChange, onSizeChange, onClear, onInsertImage }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '8px', alignItems: 'center', padding: '8px 12px', borderBottom: '1px solid #e5e7eb', flexWrap: 'wrap' }}>
      ...
      <button
        ...
        style={{ padding: '6px 12px', borderRadius: '6px', border: '1px solid #d1d5db', background: '#fff', color: '#374151', cursor: 'pointer' }}
      >
        🖼 Image
      </button>
      <input
